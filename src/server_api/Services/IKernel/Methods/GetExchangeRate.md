...
|-----------------|----------------------|----------------|----------------|
| codCurrency     | string               | -              | Արտարժույթի կոդ։ |
| date            | DateTime             | -              | Փոխարժեքի նշանակման ամսաթիվ/ժամանակ։ |
| maxCreationDate | DateTime?            | null           | Փոխանցված լինելու դեպքում մեթոդը փնտրում է փոխարժեք, որի նշանակման ամսաթիվը չի գերազանցում փոխանցված ամսաթիվը: |
