...
Տեսակը որոշվում է տվյալների աղբյուրը նկարագրող դասի [IsSQLBased](../DataSource/Properties/IsSQLBased.md) հատկության միջոցով, որի լռությամբ արժեքը **true** է։
...
- Կոնստրուկտորում ավելացնել տվյալների աղբյուրի սխեման, որը նախատեսված է տվյալների աղբյուրի սյուների ու պարամետրերի հատկությունները պահման համար։
  Դա անելու համար անհրաժեշտ է բազային դասի [Schema](../DataSource/Properties/Schema.md) հատկությանը վերագրել [Schema](../../Types/schema.md) տիպի նոր օբյեկտ՝ կոնստրուկտորին փոխանցելով հետևյալ պարամետրերը՝
...
- Սխեմայում ավելացնել տվյալների աղբյուրի սյուների հատկությունները [Schema](../../Types/schema.md) դասի [AddColumn](../../Types/schema/Methods/AddColumn.md) մեթոդի միջոցով` փոխանցելով հետևյալ պարամետրերը՝
...
- Սխեմայում ավելացնել պարամետրերի հատկությունները [Schema](../../Types/schema.md) դասի [AddParam](../../Types/schema/Methods/AddParam.md) մեթոդի միջոցով` փոխանցելով հետևյալ պարամետրերը՝
...
Վերևում նշված [ընդհանուր քայլերից](#տվյալների-աղբյուրի-նկարագրման-համար-անհրաժեշտ-ընդհանուր-քայլեր) կատարումից հետո անհրաժեշտ է override անել [IsSQLBased](../DataSource/Properties/IsSQLBased.md) հատկությունը՝ վերադարձնելով false արժեք և [FillData](../DataSource/Methods/FillData.md) մեթոդը՝ տվյալները ձևավորելու համար։  

[FillData](../DataSource/Methods/FillData.md) մեթոդում անհրաժեշտ է ստեղծել տվյալների աղբյուրի սյուները նկարագրող դասի օբյեկտներ, լրացնել սյուների   արժեքները և ստեղծված տողերը ավելացնել տվյալների աղբյուրի [Rows](../DataSource/Properties/Rows.md) տողերի ցուցակին։
