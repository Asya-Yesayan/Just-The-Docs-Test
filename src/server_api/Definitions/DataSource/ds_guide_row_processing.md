...
Sql-based տվյալների աղբյուրի տողերի հավելյալ մշակման, ֆիլտրման և հաշվարկային սյուների արժեքների հաշվարկման համար կարող են օգտագործվել երկու մեթոդներ՝ [ProcessRow](../DataSource/Methods/ProcessRow.md) և [AfterDataReaderClose](../DataSource/Methods/AfterDataReaderClose.md): 
...
Մեթոդը կանչվում է [MakeSqlCommand](../DataSource/Methods/MakeSQLCommand.md) մեթոդում ձևավորված SQL հարցման կատարման ընթացքում, երբ հարցման տվյալները կարդացող [SqlDataReader](https://learn.microsoft.com/en-us/dotnet/api/microsoft.data.sqlclient.sqldatareader)-ը դեռ բաց է:
...
reader-ից տողերը կարդալը առավել արագացնելու համար կարելի է [AfterExecuteSQLCommand](../../Definitions/DataSource/Methods/AfterExecuteSQLCommand.md) մեթոդում ստանալ reader-ի մեջ հարկավոր դիրքերը։
...
AfterDataReaderClose-ի աշխատանքի երկու տարբերակ կա կախված գերբեռնվող [AfterDataReaderCloseMode](../DataSource/Properties/AfterDataReaderCloseMode.md) հատկության արժեքից՝
