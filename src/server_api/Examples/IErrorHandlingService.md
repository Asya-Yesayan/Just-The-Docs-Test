...
- մշակում է սխալի հաղորդագրությունը [GetSqlExceptionText](../Services/IErrorHandling/Methods/GetSqlExceptionText.md) մեթոդի միջոցով,
- գրանցում լոգում,
