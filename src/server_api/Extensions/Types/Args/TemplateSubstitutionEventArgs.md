...
Այս դասը պարունակում է փաստաթղթի տպելու ձևանմուշի տվյալներ և օգտագործվում է [DocumentExtender](../../Definitions/DocumentExtender/document_extender.md)-ի [PostTemplateSubstitution](../../Definitions/DocumentExtender/Methods/PostTemplateSubstitution.md), [PostTemplateSubstitutionEx](../../Definitions/DocumentExtender/Methods/PostTemplateSubstitutionEx.md) մեթոդներում։
