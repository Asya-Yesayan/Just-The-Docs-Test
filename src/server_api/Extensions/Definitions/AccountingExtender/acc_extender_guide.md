...
Գոյություն ունեցող [հաշվառումների](../../../Definitions/Accounting/accounting.md) մշակման գործընթացում լրացուցիչ ստուգումներ իրականացնելու և այլ սեփական տրամաբանություն ավելացնելու համար նկարագրվում է [հաշվառման ընդլայնումը](acc_extender.md)։

[Հաշվառման ընդլայնումը](acc_extender.md) իրանից ներկայացնում է վիրտուալ մեթոդների բազմություն, որոնք կանչվում են [հաշվառման հիմնական իրադարձություններից](../../../Definitions/Accounting/accounting.md) առաջ և հետո։ 
...
- [OnDelete](../../../Definitions/Accounting/Methods/OnDelete.md) մեթոդով [հաշվառումը](../../../Definitions/Accounting/accounting.md) հեռացնելուց առաջ լրացուցիչ տրամաբանություն ավելացնելու համար անհրաժեշտ է override անել [PreOnDelete](Methods/PreOnDelete.md) մեթոդը։
...
- [OnDelete](../../../Definitions/Accounting/Methods/OnDelete.md) մեթոդով [հաշվառումը](../../../Definitions/Accounting/accounting.md) հեռացնելուց հետո լրացուցիչ տրամաբանություն ավելացնելու համար անհրաժեշտ է override անել [PostOnDelete](Methods/PostOnDelete.md) մեթոդը։
