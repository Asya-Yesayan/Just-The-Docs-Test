...
|----------|----------------|
| [PreOnDelete(Accounting, OnDeleteEventArgs)](Methods/PreOnDelete.md) | PreOnDelete իրադարձությունը առաջանում է հաշվառումը ջնջելու ժամանակ` հաշվառման OnDelete իրադարձությունից առաջ։ |
| [PostOnDelete(Accounting, OnDeleteEventArgs)](Methods/PostOnDelete.md) | PreOnDelete իրադարձությունը առաջանում է հաշվառումը ջնջելու ժամանակ` հաշվառման OnDelete իրադարձությունից հետո։ |
