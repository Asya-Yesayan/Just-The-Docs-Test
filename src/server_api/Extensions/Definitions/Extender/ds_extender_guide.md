...
2. Ընդլայնող դասի կոնստրուկտորի մեջ՝ [AddColumn](Methods/AddColumn.md) ֆունկցիայի միջոցով։
...
Ընդլայնված սյունակների հաշվարկը հարկավոր է կատարել [ProccessRow](Methods/ProccessRow.md) ֆունկցիայի մեջ, որը կանչվում է յուրաքանչյուր տողի համար։
...
Եթե ինչ-որ տվյալներ հարկավոր է հաշվարկել և քեշավորել նախքան [ProccessRow](Methods/ProccessRow.md)-ի աշխատանքը, ապա հարկավոր է մշակել [BeforeProcess](Methods/BeforeProcess.md) ֆունկցիան։ 
...
Տվյալ օրինակում քեշավորվել են ծառի էլեմենտները և հետո օգտագործվել [ProccessRow](Methods/ProccessRow.md) ֆունկցիայում։
