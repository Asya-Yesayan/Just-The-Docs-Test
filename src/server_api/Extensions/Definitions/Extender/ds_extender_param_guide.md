...
2. Ընդլայնող դասի կոնստրուկտորի մեջ՝ [AddParam](Methods/AddParam.md) ֆունկցիայի միջոցով։
...
[AddParam](Methods/AddParam.md) ֆունկցիային հարկավոր է փոխանցել հետևյալ արժեքները՝
...
Պարամետրին դիմելու համար [BeforeProcess](Methods/BeforeProcess.md) ֆունկցիայում 
...
Եթե ընդլայնված պարամետրով փոխանցված հաճախորդի կոդ, ապա [ProccessRow](Methods/ProccessRow.md) ֆունկցիայում ստուգվում է, որ տվյալների աղբյուրի յուրաքանչյուր տողում գրված հաշիվը (դեբետում կամ կրեդիտում) լինի [BeforeProcess](Methods/BeforeProcess.md)-ում ստացած հաշիվների ցանկում։
Եվ առկայության դեպքում [ProccessRow](Methods/ProccessRow.md) ֆունկցիան վերադարձնում է `true`, որպեսզի տողը ընդգրկվի վերջնական ցանկում։ Ցանկում չլինելու դեպքում վերադարձնում է `false` տողը վերջնական ցանկից հանելու համար։
