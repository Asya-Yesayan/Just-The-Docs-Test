...
Հիմնականում օգտագործվում է [տպելու ձևերի ընդլայնման](../TemplateSubstitution/template_substitution.md) նկարագրման համար։

Տե՛ս նաև
* [Տպելու ձևերի ընդլայնման նկարագրություն](../TemplateSubstitution/template_substitution.md)
* [Տպելու ձևերի ընդլայնման ձեռնարկ](../TemplateSubstitution/template_substitution_guide.md)
