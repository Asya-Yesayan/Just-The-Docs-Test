...
* .as ընդլայնմամբ ֆայլ սկրիպտերում [SERVERSIDEMODULE](../ServerSideModule/server_side_module_guide.md) նկարագրությամբ, որը պարունակում է մետատվյալներ ընդլայնման մասին,
...
|----------|----------------|
| [Calculate(TemplateSubstitutionExtenderArgs)](Methods/Calculate.md) | Իրականացնում է տպելու ձևանմուշի ընդլայնման պարամետրերի հաշվարկը։ |
