...
Օգտագործվում է [սերվերային մոդուլ](../ServerSideModule/server_side_module_guide.md) ընդլայնումը համակարգ ներմուծելու համար։ Անհրաժեշտ է ստեղծել երկու ֆայլ՝
1.	պարամետրերի հաշվարկի ծրագրերը պարունակող C# ֆայլը,
2.	`.as` ընդլայնումով [սերվերային մոդուլի](../ServerSideModule/server_side_module_guide.md) նկարագրող ֆայլը, որը օգտագործվում է C# ֆայլը ներմուծելիս։

Ստեղծված ֆայլերը պետք է [ներմուծել](../ServerSideModule/server_side_module_guide.md#ֆայլերի-ներմուծում) համակարգ, որից հետո [կապակցել](#ընդլայնման-կապակցում-տպելու-ձևանմուշին) տպվող ձևի ձևանմուշին։
...
Պարամետրի հաշվարկը և ավելացումը հնարավոր է կատարել նաև [UserProxyService](../../../../Bank/Extensions/user_proxy_service.md)-ի [TryAddAtomic](../../../../Bank/Extensions/user_proxy_service.md#tryaddatomic) կամ [TryAddAtomicAsync](../../../../Bank/Extensions/user_proxy_service.md#tryaddatomic) մեթոդներով։
...
![Ընդլայնման կապակցում ձևանմուշին](../Images/template_substitution_guide_connect_template.png)
