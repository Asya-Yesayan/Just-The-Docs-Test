...
**Օրինակ**.  
Համակարգում սահմանված է [TreeElementService](../server_api/Services/TreeElements/TreeElementsService.md), որը իր կոնստրուկտորում պետք է ստանա 4 պարամետր։
...
[TreeElementService](../server_api/Services/TreeElements/TreeElementsService.md) դասը իր կախվածությունները ([IDBService](../server_api/Services/IDB/IDBService.md), TimeStampService, TreeService և IErrorHandlingService) ստանում է կոնստրուկտորով ինյեկցիայի միջոցով: 
...
`TreeNode` դասը իր կախվածությունը՝ [IDBService](../server_api/Services/IDB/IDBService.md), ստանում է կոնստրուկտորով ինյեկցիայի միջոցով, ինչպես նաև `IServiceProvider`, որը փոխանցում է բազային [DataSource](../server_api/Definitions/DataSource/DataSource.md) դասին: 
Այս դասը վերագրվում է դասի ներսում նախապես հայտարարված լոկալ փոփոխականին (`dbService`) և օգտագործվում է դասի ներսում: 

Օրինակում օգտագործված տվյալների աղբյուրի նկարագրման ձեռնարկին ծանոթանալու համար [տե՛ս](../server_api/Definitions/DataSource/ds_guide.md):  
...
`TreeController` դասը, որը նախատեսված է ծառերի և ծառերի հանգույցներին վերաբերող Http հարցումների կատարաման համար, իր կախվածությունները (TreeService, [TreeElementService](../server_api/Services/TreeElements/TreeElementsService.md)) ստանում է կոնստրուկտորով ինյեկցիայի միջոցով: 
Այս սերվիսները վերագրվում են դասի ներսում նախապես հայտարարված լոկալ փոփոխականներին և օգտագործվում են դասի ներսում: 
